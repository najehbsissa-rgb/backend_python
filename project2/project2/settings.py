...
SECRET_KEY = 'django-insecure-o=fx63=+i9%v7dip7xh=n@gb@ex*7)g)467+qfg2b8iih0y3_&'
...
DATABASES = {
    "default": {
        ...
        "NAME": "project",          # Le nom de ta base de données PostgreSQL
        "USER": "postgres",        # Ton nom d'utilisateur PostgreSQL
        "PASSWORD": "postgres",    # Ton mot de passe PostgreSQL
        "HOST": "localhost",       # Adresse du serveur (localhost si local)
